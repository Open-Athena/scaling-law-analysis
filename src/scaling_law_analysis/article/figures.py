...
def copy_experiment_outputs(output_dir: Path) -> None:
    ...
    error_costs_dir = prepare_output_dir(
        output_dir / "figures" / "compute_allocation_errors"
    )
    main_copies = [
        (
            exp_dir / "exp10" / "compounding_errors.png",
            compounding_dir / "compounding_errors.png",
        ),
        (
            exp_dir / "exp10" / "compounding_errors.csv",
            compounding_dir / "compounding_errors.csv",
        ),
        (
