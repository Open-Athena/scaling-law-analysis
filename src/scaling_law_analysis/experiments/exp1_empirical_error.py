...
def create_figure(
    ...
    fig.suptitle(
        f"Experiment 1: Approach 2 Accuracy vs Grid Resolution (fit on {fit_mode})\n"
...
def main():
    ...
    results = run_experiment(compute_budgets, log_ranges, n_points, use_log_loss=use_log_loss)
