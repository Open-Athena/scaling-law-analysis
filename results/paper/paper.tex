...
conditions. Two independent bias sources are identified: loss surface asymmetry
($\alpha \neq \beta$), which shifts intercept estimates, and off-center
sampling, which distorts intercepts or exponents depending on whether the offset
is constant or varies with compute budget. Chinchilla Approach~3 eliminates
