...
At that first extreme, you can imagine that “economic outputs” (e.g. human labor equivalents) are never going to be so predictable from “economic inputs” (e.g. hero runs at fractional GDP cost) that they warrant being called a “law”. At the other extreme, it’s much easier to believe that more direct relationships between capability like validation loss, eval performance, task time-horizon, etc. and resources like model size, data volume, FLOPs, etc. might be quantifiable with higher accuracy.
